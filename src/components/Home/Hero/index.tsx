...
const Hero: React.FC = () => {
  ...
  return (
    <section ref={pageref} className='!py-0'>
      <div className='bg-gradient-to-b from-skyblue via-lightskyblue dark:via-[#4298b0] to-white/10 dark:to-black/10 overflow-hidden relative'>
        <div className='container max-w-8xl mx-auto px-5 2xl:px-0 pt-32 md:pt-60 md:pb-68'>
          <div className='relative text-white dark:text-dark text-center md:text-start z-10'>
            <p className=' slide-right text-inherit text-xm font-medium'>Palm springs, CA</p>
            <h1 className='slide-right text-inherit text-6xl sm:text-9xl font-semibold -tracking-wider md:max-w-45p mt-4 mb-6'>
              Futuristic Haven
            </h1>
            <div className=' slide-right flex flex-col xs:flex-row justify-center md:justify-start gap-4'>
          ...
          <div className=' slide-right hidden md:block absolute -top-2 -right-68'>
            <Image
        ...
        <div className='md:absolute bottom-0 md:-right-68 xl:right-0 bg-white dark:bg-black py-12 px-8 mobile:px-16 md:pl-16 md:pr-[295px] rounded-2xl md:rounded-none md:rounded-tl-2xl mt-24'>
          <div className='grid grid-cols-2 sm:grid-cols-4 md:flex gap-16 md:gap-24 sm:text-center dark:text-white text-black'>
            <div className=' slide-right flex flex-col sm:items-center gap-3'>
              <Image
